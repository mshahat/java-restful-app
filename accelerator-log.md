...
```json
{
  ...
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=mshahat&repo=java-restful-app",
  "buildTool" : "maven",
  ...
  "sourceRepositoryPrefix" : "eu.gcr.io/pa-mshahat"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗  Info Condition (#databaseType == 'postgres') evaluated to false
┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8] (Combo)
┃ ┃ ┃ ┃ ┃  Info Condition (#databaseType == 'mysql') evaluated to true
┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol databaseMySQLStorageClassResourceName with value 'standard'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Merge, UniquePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0] (Merge)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Merge(Combo, Combo, Combo, Combo, Combo, Combo, Combo, Combo, Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[0] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[0].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, Exclude)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[0].delegate.transformations[0] (Include)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will include [**]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/restservicedb/api/CustomerProfileControllerTest.java matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/migration/V1.0__create_customer_profile_table.sql matched [**] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/test-pipeline.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml matched [**] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[0].delegate.transformations[1] (Exclude)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/restservicedb/api/CustomerProfileControllerTest.java didn't match [docker-compose.yaml, **/src/main/resources/application-local.properties, **/src/test/resources/application-test.properties, **/workload.yaml, config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml, pom.xml, build.gradle.kts, README.md] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md matched [docker-compose.yaml, **/src/main/resources/application-local.properties, **/src/test/resources/application-test.properties, **/workload.yaml, config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml, pom.xml, build.gradle.kts, README.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md matched [docker-compose.yaml, **/src/main/resources/application-local.properties, **/src/test/resources/application-test.properties, **/workload.yaml, config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml, pom.xml, build.gradle.kts, README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml matched [docker-compose.yaml, **/src/main/resources/application-local.properties, **/src/test/resources/application-test.properties, **/workload.yaml, config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml, pom.xml, build.gradle.kts, README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml matched [docker-compose.yaml, **/src/main/resources/application-local.properties, **/src/test/resources/application-test.properties, **/workload.yaml, config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml, pom.xml, build.gradle.kts, README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml matched [docker-compose.yaml, **/src/main/resources/application-local.properties, **/src/test/resources/application-test.properties, **/workload.yaml, config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml, pom.xml, build.gradle.kts, README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml matched [docker-compose.yaml, **/src/main/resources/application-local.properties, **/src/test/resources/application-test.properties, **/workload.yaml, config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml, pom.xml, build.gradle.kts, README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml matched [docker-compose.yaml, **/src/main/resources/application-local.properties, **/src/test/resources/application-test.properties, **/workload.yaml, config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml, pom.xml, build.gradle.kts, README.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[1] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#databaseIntegrationTestType == 'testcontainers') evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Include
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[1].delegate (Include)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [docker-compose.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [docker-compose.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [docker-compose.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [docker-compose.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [docker-compose.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [docker-compose.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#databaseIntegrationTestType == 'testcontainers') evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, Combo, OpenRewriteRecipe, OpenRewriteRecipe, OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[0] (Include)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [**/src/main/resources/application-local.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [**/src/main/resources/application-local.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [**/src/main/resources/application-local.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [**/src/main/resources/application-local.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [**/src/main/resources/application-local.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [**/src/main/resources/application-local.properties] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[1] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[1].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Merge, UniquePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[1].delegate.transformations[0] (Merge)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Merge(ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[1].delegate.transformations[0].sources[0] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[1].delegate.transformations[1] (UniquePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[2] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[3] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[2].delegate.transformations[4] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#databaseIntegrationTestType == 'testcontainers') evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, Combo, OpenRewriteRecipe, OpenRewriteRecipe, OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[0] (Include)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [**/src/test/resources/application-test.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [**/src/test/resources/application-test.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [**/src/test/resources/application-test.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [**/src/test/resources/application-test.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [**/src/test/resources/application-test.properties] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [**/src/test/resources/application-test.properties] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[1] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[1].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Merge, UniquePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[1].delegate.transformations[0] (Merge)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Merge(ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[1].delegate.transformations[0].sources[0] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[1].delegate.transformations[1] (UniquePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[2] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[3] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[3].delegate.transformations[4] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[4] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[4].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, ReplaceText, OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[4].delegate.transformations[0] (Include)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [**/workload.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [**/workload.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [**/workload.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [**/workload.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [**/workload.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [**/workload.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[4].delegate.transformations[1] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [mysql-database->customer-database]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[4].delegate.transformations[2] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[5] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[5].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[5].delegate.transformations[0] (Include)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will include [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/restservicedb/api/CustomerProfileControllerTest.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/migration/V1.0__create_customer_profile_table.sql didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .gitignore didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileServiceTest.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/restservicedb/ApplicationTests.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileResponse.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileCreateRequest.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/restservicedb/api/CustomerProfileController.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.properties didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug DATABASE.md didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/restservicedb/data/CustomerProfileRepositoryTest.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileChangeRequest.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/restservicedb/data/CustomerProfileEntity.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/restservicedb/Application.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzuignore didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug catalog/catalog-info.yaml didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .mvn/wrapper/maven-wrapper.properties didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileService.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/restservicedb/data/CustomerProfileRepository.java didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug manifest.yaml didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug pom.xml didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/workload.yaml didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/test-pipeline.yaml didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml matched [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml matched [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml matched [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml matched [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml matched [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug docker-compose.yaml didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application-local.properties didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ Debug src/test/resources/application-test.properties didn't match [config/service-operator/mysql.yaml, config/service-operator/mysql-cluster-role.yaml, config/service-operator/mysql-cluster-instance-class.yaml, config/app-operator/mysql-resource-claim.yaml, config/app-operator/mysql-resource-claim-policy.yaml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[5].delegate.transformations[1] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [storage-class-standard->standard, mysqldatabase->customer-database, mysql-database->customer-database]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[6] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[6].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, ReplaceText, ReplaceText, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[6].delegate.transformations[0] (Include)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will include [pom.xml]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/restservicedb/api/CustomerProfileControllerTest.java didn't match [pom.xml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [pom.xml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/migration/V1.0__create_customer_profile_table.sql didn't match [pom.xml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/test-pipeline.yaml didn't match [pom.xml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [pom.xml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [pom.xml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [pom.xml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [pom.xml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [pom.xml] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [pom.xml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[6].delegate.transformations[1] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace regex '(?<startOfDependencies><dependencies>)(?<existingDependencies>(?![\s\S]+<groupId>mysql</groupId>\s*<artifactId>mysql-connector-java</artifactId>[\s\S]+</dependencies>))' with '${startOfDependencie...(truncated)'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[6].delegate.transformations[2] (ReplaceText)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[6].delegate.transformations[3] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#databaseIntegrationTestType == 'testcontainers') evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace regex '(?<startOfDependencies><dependencies>)(?<existingDependencies>(?![\s\S]+<groupId>org.testcontainers</groupId>\s*<artifactId>mysql</artifactId>[\s\S]+</dependencies>))' with '${startOfDependencie...(truncated)'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[7] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[7].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, ReplaceText, ReplaceText, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[7].delegate.transformations[0] (Include)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will include [build.gradle.kts]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/restservicedb/api/CustomerProfileControllerTest.java didn't match [build.gradle.kts] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [build.gradle.kts] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/migration/V1.0__create_customer_profile_table.sql didn't match [build.gradle.kts] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/test-pipeline.yaml didn't match [build.gradle.kts] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [build.gradle.kts] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [build.gradle.kts] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [build.gradle.kts] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [build.gradle.kts] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [build.gradle.kts] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [build.gradle.kts] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[7].delegate.transformations[1] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace regex '(?<startOfDependencies>dependencies \{)(?<existingDependencies>(?![\s\S]+implementation\s*\("mysql:mysql-connector-java[\s\S]+))' with '${startOfDependencie...(truncated)'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[7].delegate.transformations[2] (ReplaceText)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[7].delegate.transformations[3] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#databaseIntegrationTestType == 'testcontainers') evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace regex '(?<startOfDependencies>dependencies \{)(?<existingDependencies>(?![\s\S]+testImplementation\s*\("org.testcontainers:mysql[\s\S]+))' with '${startOfDependencie...(truncated)'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, Combo, ReplaceText, ReplaceText, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[0] (Include)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug README.md didn't match [DATABASE.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [DATABASE.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [DATABASE.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [DATABASE.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [DATABASE.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [DATABASE.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[1] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[1].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Merge, UniquePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[1].delegate.transformations[0] (Merge)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Merge(ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[1].delegate.transformations[0].sources[0] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[1].delegate.transformations[1] (UniquePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will replace regex '\[tap\]' with '### MySQL
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info 
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Using the...(truncated)'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[3] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Condition (#databaseIntegrationTestType == 'in-memory') evaluated to false
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[0].sources[8].delegate.transformations[4] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#databaseIntegrationTestType == 'testcontainers') evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will replace regex '\[local\]' with '### MySQL
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info 
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Running a...(truncated)'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[0].delegate.transformations[1] (UniquePath)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗ Debug Multiple representations for path 'DATABASE.md', will use the one appearing last 
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[8].delegate.transformations[0].sources[0].validated.delegate.in.transformations[1] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗ ┗  Info Condition (#databaseIntegrationTestType == 'in-memory') evaluated to false
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [dev.local->eu.gcr.io/pa-mshahat]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [DEPLOYING.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [DEPLOYING.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [DEPLOYING.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [DEPLOYING.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [DEPLOYING.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=mshahat&repo=java-restful-app'
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'config/app-operator/mysql-resource-claim.yaml', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/test/java/com/vmware/tap/accelerators/restservicedb/api/CustomerProfileControllerTest.java', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'mvnw', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/resources/db/migration/V1.0__create_customer_profile_table.sql', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path '.gitignore', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'config/service-operator/mysql-cluster-instance-class.yaml', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/test/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileServiceTest.java', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/test/java/com/vmware/tap/accelerators/restservicedb/ApplicationTests.java', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileResponse.java', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileCreateRequest.java', will use the one appearing first 
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/java/com/vmware/tap/accelerators/restservicedb/api/CustomerProfileController.java', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/resources/application.properties', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'config/service-operator/mysql.yaml', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'DATABASE.md', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/test/java/com/vmware/tap/accelerators/restservicedb/data/CustomerProfileRepositoryTest.java', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileChangeRequest.java', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/java/com/vmware/tap/accelerators/restservicedb/data/CustomerProfileEntity.java', will use the one appearing first 
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path '.tanzuignore', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'LICENSE', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'config/service-operator/mysql-cluster-role.yaml', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'mvnw.cmd', will use the one appearing first 
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/java/com/vmware/tap/accelerators/restservicedb/domain/CustomerProfileService.java', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'config/workload.yaml', will use the one appearing first 
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'config/app-operator/mysql-resource-claim-policy.yaml', will use the one appearing first 
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim.yaml didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-instance-class.yaml didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql.yaml didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/service-operator/mysql-cluster-role.yaml didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/app-operator/mysql-resource-claim-policy.yaml didn't match [**/*.jar] -> included
